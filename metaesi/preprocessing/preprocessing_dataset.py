...
for i in tqdm(all_e3):
    ...
    ith_e3_esi.loc[:, 'key'] = ith_e3_esi['E3'] + '_' + ith_e3_esi['SUB']
...
for i in tqdm(all_sub):
    ...
    if len(ith_sub_pro) >= add_num:
        ...
        ith_sub_random = list(set(all_e3_entry) - ith_sub_e3 - set(ith_sub_pro) - set(ith_sub_UB2))    # 没有被考虑过的其他蛋白
    ...
    ith_sub_esi.loc[:, 'key'] = ith_sub_esi['E3'] + '_' + ith_sub_esi['SUB']
