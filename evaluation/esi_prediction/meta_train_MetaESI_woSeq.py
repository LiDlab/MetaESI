...
from metaesi import *
from metaesi.run_meta_learning import Meta_learning
...
if __name__ == "__main__":
    ...
    model_path = "../../results/esi_benchmark/architecture_ablation/MetaESI_woSeq/"
    os.makedirs(model_path, exist_ok=True)
    torch.save(model.state_dict(), model_path + "MetaESI_woSeq.pth")
