...
if __name__ == "__main__":
    ...
    features_path = "../../data/human/raw/transdsi/VGAE.npy"
    uniprot_path = "../../data/human/raw/transdsi/uniprot.tsv"
    ...
    Zeroshot_learning("MetaESI_woGARD", save_path, Dataset_train, Dataset_val, Feature, similarity_matrix, coeffs, nway = 8, kshot = 2, epochs = 10, save_path = save_path, gpu = 1)
