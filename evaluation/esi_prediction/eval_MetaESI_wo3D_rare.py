...
if __name__ == "__main__":
    ...
    Zeroshot_learning("MetaESI_wo3D", save_path, Dataset_train, Dataset_val, Feature, similarity_matrix, coeffs, nway = 8, kshot = 2, epochs = 10, save_path = save_path, gpu = 1)
