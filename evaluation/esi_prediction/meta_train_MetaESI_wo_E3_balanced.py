...
def Meta_learning(dataset, esi_count, Feature, coeffs, episodes, gpu):
    ...
    Dataset = ESIdataset_with_SUB_balanced(dataset, esi_count, coeffs['common_threshold'], coeffs['task_num'],
...
if __name__ == "__main__":
    ...
    model_path = "../../results/esi_benchmark/dataset_ablation/MetaESI_wo_E3_balanced/"
    os.makedirs(model_path, exist_ok=True)
    torch.save(model.state_dict(), model_path + "MetaESI_wo_E3_balanced.pth")
