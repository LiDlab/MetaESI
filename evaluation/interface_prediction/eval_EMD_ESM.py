...
def read_pdb_and_calculate_distances(pdb_file_path):
    """
    Parse PDB file and calculate C-alpha distance matrix between two chains.
...
def generate_interface_EMD(val):
    ...
    for e3 in tqdm(all_e3):
        ...
        for idx in range(len(dataset_val_e3)):
            ...
            file_name = "{}_{}_ESM.pdb".format(x0, x1)
...
if __name__=="__main__":
    ...
    boxplot.to_csv(save_path + "Interface_EMD_by_ESM.csv", index=False)
