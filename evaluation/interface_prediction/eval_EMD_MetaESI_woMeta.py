...
def generate_interface_EMD(val, Dataset, Feature, gpu):
    ...
    for e3 in tqdm(all_e3):
        ...
        model = fetch_e3_specific_model(e3, Dataset, Feature, gpu
                                        , meta_model_path="../../results/esi_benchmark/architecture_ablation/MetaESI_woMeta/"
                                        , e3_model_path="../../results/esi_benchmark/architecture_ablation/MetaESI_woMeta/e3_specific_model_woMeta/"
                                        , meta_model_name = "MetaESI_woMeta.pth")
...
if __name__=="__main__":
    ...
    metaesi_EMD.to_csv(save_path + "Interface_EMD_by_MetaESI_woMeta.csv", index=False)