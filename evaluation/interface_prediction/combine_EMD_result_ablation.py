...
MetaESIwoML = pd.read_csv(data_path + "Interface_EMD_by_MetaESI_woMeta.csv")

# Process MetaESI data with direct column selection
MetaESI = MetaESI[['ELMIdentifier', 'E3_Entry', 'Site', 'sub_Entry', 'Start', 'End', 'MetaESI Score', 'MetaESI Interface Residues (E3)', 'MetaESI Interface Residues (SUB)',
...
MetaESIwoML = rename_and_select_columns(MetaESIwoML, 'MetaESIwoML')

# Combine multiple DataFrames using merge operations
dfs = [MetaESI, MetaESIwoSeq, MetaESIwo3D, MetaESIwoGARD, MetaESIwoML]
